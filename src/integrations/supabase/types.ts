...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      user_sports: {
        Row: {
          ...
          is_primary: boolean
          level: string | null
          practicing_since_months: number | null
          priority: number
          sport_id: string
          updated_at: string
          user_id: string
    ...
    Functions: {
      ...
      discover_people: {
        Args: { _limit?: number; _max_km?: number; _sport_id?: string }
        Returns: {
          avatar_url: string
          city: string
          display_name: string
      ...
      set_my_location: {
        Args: { _lat: number; _lng: number; _precision?: string }
        Returns: undefined
      }
      st_3dclosestpoint: {
        Args: { geom1: unknown; geom2: unknown }
